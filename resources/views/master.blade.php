...
<head>
    ...
    <title>Điện Lực Bình Dương</title>
    ...
    <body>
            ...
            <div class="navbar-inner">
                <div class="container">
                    ...
                    <a href="{!! URL('home') !!}" class="brand">
                        <img src="{{ url('public/lib/images/logoevn.png')}}" width="30px" height="50px" style="margin-top:-4px">Điện Lực Bình Dương
                    </a>
                    <div id="app-nav-top-bar" class="nav-collapse">
                        @if(Auth::user()->nguoidung_id == 2) 
                        <ul class="nav">
                            <li class="dropdown">
        ...
        <footer class="application-footer">
            <div class="container">
                        <b> <p>Đại học Thủ Dầu Một</p></b>
                        <div class="disclaimer">
                            <p>Địa chỉ: Số 06 Trần Văn Ơn, Phú Hoà, Thủ Dầu Một, Bình Dương</p>
                            <p>Điện thoại:0274 3822 518 - Fax: 0274 3822 518;  Email: tdmu@tdmu.vn</p>
                        </div>
            </div>
        </footer>
	</body>
